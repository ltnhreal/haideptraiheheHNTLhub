...
L_1_[38] = L_1_[16]:MakeWindow({
	["Title"] = "HNTL X NanoQ8 hub";
	["SubTitle"] = "by ltnhreal & q8ta0e",
				...
				["fields"] = {
					{
						...
						["name"] = "Script",
						["value"] = "`" .. tostring('game:GetService("TeleportService"):TeleportToPlaceInstance(game.PlaceId, "' .. game.JobId .. '", game.Players.LocalPlayer)') .. "`",
						["inline"] = false
					}
				},
				["footer"] = {
					["text"] = "Made by q8ta0e",
					["icon_url"] = "https://cdn.discordapp.com/attachments/1423702366871359569/1454376241988636773/IMG_1892.jpg?ex=6950dced&is=694f8b6d&hm=c11ba9427f08e312a4b40c7f6b29cc9d287054c55329efc129a14bf2a28ab418&"
				},
...
spawn(function()
	while wait(.2) do
		pcall(function()
			if Getmoon() == "http://www.roblox.com/asset/?id=9709143733" then
				if not hasNotifyNearFM then
					hasNotifyNearFM = true
					SendWebhook({
						Url = "https://discord.com/api/webhooks/1454352058940526635/o5sbgRHU7fGjhJT6Ns2cuyzTed87e6G4pRiPOtB3Q74sGyrfZxCSCOMHmc1TmberXqgN",
						Title = "Moon (Sea3)",
						Value = "Near Full Moon"
					})
				end
			elseif Getmoon() == "http://www.roblox.com/asset/?id=9709149431" then
				if not hasNotifyFM then
					hasNotifyFM = true
					SendWebhook({
						Url = "https://discord.com/api/webhooks/1454352058940526635/o5sbgRHU7fGjhJT6Ns2cuyzTed87e6G4pRiPOtB3Q74sGyrfZxCSCOMHmc1TmberXqgN",
						Title = "Moon (Sea3)",
...
spawn(function()
	while wait(.2) do
		if workspace.Map:FindFirstChild("KitsuneIsland") or workspace._WorldOrigin.Locations:FindFirstChild("Kitsune Island") then
			if not hasNotifyKit then
				hasNotifyKit = true
				SendWebhook({
					Url = "https://discord.com/api/webhooks/1454383589859791000/jSaUaA6Z-1_yDlwaWHL53MddwcFSeLevuqx9m_DnXlSbyBkBlkF1q_GKPf-Rb5ye8UY-",
					Title = "Kitsune",
					Value = "Spawned Kitsune Island"
				})
			end
		else
			hasNotifyKit = false
		...
		if workspace.Map:FindFirstChild("MysticIsland") or workspace._WorldOrigin.Locations:FindFirstChild("Mirage Island") then
			if not hasNotifyMir then
				hasNotifyMir = true
				SendWebhook({
					Url = "https://discord.com/api/webhooks/1454384041984786472/e7lXPcR-D8WMJgSFM0eWK3kFWM_VrOL6TbZhBYkWuJFR97VU2ttDIWXd2SSjhpRViKJr",
					Title = "Mirage",
					Value = "Spawned Mirage Island"
				})
			end
		else
			hasNotifyMir = false
    ...
    while wait() do
        pcall(function()
            ...
            or game:GetService("Workspace").Enemies:FindFirstChild("rip_indra") then
					if not hasNotifyRipInGay then
						hasNotifyRipInGay = true
						SendWebhook({
							Url = "https://discord.com/api/webhooks/1454400869830234179/GqbnRNeb8duBcyO-4mIO8bwiCWMhW9oJWn4I-qnf8Jt1evFT5QV14J6rUq5lW9E1PgHU",
							Title = "Rip Indra",
							Value = "Spawned Rip Indra"
						})
					end
            else
                hasNotifyRipInGay = false
            end
        end)
    end
end)
    ...
    while wait() do
        pcall(function()
            if game:GetService("ReplicatedStorage"):FindFirstChild("Dough King") then
					if not hasNotifyDough then
						hasNotifyDough = true
						SendWebhook({
							Url = "https://discord.com/api/webhooks/1454400806768869461/wo_o72dG2NQOMdFNCwbBkqAqybK2qofMyIla5r1sXoCkQFcvVIdniDMOJAf0D_OIKwnX",
							Title = "Dough King",
							Value = "Spawned Dough King"
						})
					end
            else
                hasNotifyDough = false
            end
        end)
    end
end)
...
spawn(function()
	while wait(.2) do
		...
		if haki then
			if not hasNotifyHaki1 and haki == "Pure Red" then
				hasNotifyHaki1 = true
				SendWebhook({
					Url = "https://discord.com/api/webhooks/1454384193781104691/VO3rgqRDeNpc0fEcztziFv8lM5toIJK6l85a70pZKJy9pR39MmKn8IDr40uaSjud-A3y",
					Title = "Haki Color",
					Value = "Pure Red"
				})
			end
			if not hasNotifyHaki2 and haki == "Snow White" then
				hasNotifyHaki2 = true
				SendWebhook({
					Url = "https://discord.com/api/webhooks/1454384193781104691/VO3rgqRDeNpc0fEcztziFv8lM5toIJK6l85a70pZKJy9pR39MmKn8IDr40uaSjud-A3y",
					Title = "Haki Color",
			...
			if not hasNotifyHaki3 and haki == "Winter Sky" then
				hasNotifyHaki3 = true
				SendWebhook({
					Url = "https://discord.com/api/webhooks/1454384193781104691/VO3rgqRDeNpc0fEcztziFv8lM5toIJK6l85a70pZKJy9pR39MmKn8IDr40uaSjud-A3y",
					Title = "Haki Color",
			...
			hasNotifyHaki1 = false
			hasNotifyHaki2 = false
			hasNotifyHaki3 = false
		end;
	end;
end);
end
	...
	pcall(function()
		while wait() do
			...
			if rs:InvokeServer("LegendarySwordDealer", "1") then
				if not hasNotifyS1 then
					hasNotifyS1 = true
					SendWebhook({
						Url = "https://discord.com/api/webhooks/1454395719635963975/CCKcQEh64mJmVSvtzTNlZJdVregRi1slrwapfVqknOGY3Y9cJ2Sesn5X-3Zapf8I4CEY",
						Title = "Legendary Sword",
						Value = "Shisui"
					})
				end
			elseif rs:InvokeServer("LegendarySwordDealer", "2") then
				if not hasNotifyS2 then
					hasNotifyS2 = true
					SendWebhook({
						Url = "https://discord.com/api/webhooks/1454395719635963975/CCKcQEh64mJmVSvtzTNlZJdVregRi1slrwapfVqknOGY3Y9cJ2Sesn5X-3Zapf8I4CEY",
						Title = "Legendary Sword",
